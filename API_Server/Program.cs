...
builder.Services.AddDbContext<CarCompanySourceContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection"))
    );

builder.Services.AddIdentity<CarAppUser, IdentityRole>()
    .AddEntityFrameworkStores<CarCompanySourceContext>();
